...
Hermes Reach is informed by, but does not vendor code from:
...
Hermes Reach routes to specialized engines instead of replacing them:
...
Hermes Reach also borrows ideas from harness-first agent systems:
...
Hermes Reach is licensed under BSD 3-Clause. Redistribution must preserve the copyright notice, license text, and this notice file when distributed with the source tree.
